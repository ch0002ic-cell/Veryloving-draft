...
| Local and backend PII | Mobile Storage + Backend Privacy | Account-bound encrypted local contacts/location/history/queues, migration from legacy keys, deletion tombstones, vendor export/deletion orchestration, retention jobs, backup/restore and rollback evidence. |
