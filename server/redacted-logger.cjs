...
const SENSITIVE_KEY = /(?:authorization|token|apikey|secret|password|serial|serialnumber|pairingcode|qrcode|email|phone|phonenumber|address|coordinates|location|latitude|longitude|userid|accountid|subject|deviceid|deviceref|sourcedeviceref)$/i;
