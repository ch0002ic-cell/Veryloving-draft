  ...
  return (
    <View style={styles.wrap}>
      ...
      <View style={[styles.inputRow, showValidation && !phone.isValid && styles.invalidInput]}>
        ...
        />
        {phone.isValid ? <Ionicons name="checkmark-circle" size={20} color={colors.green} /> : null}
      </View>
      <Text
...
const styles = StyleSheet.create({
  ...
  inputRow: { minHeight: 52, paddingRight: 12, flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: colors.line, borderRadius: 8, backgroundColor: '#fff' },
